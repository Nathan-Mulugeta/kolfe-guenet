function CardSectionSvg() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" className="h-full">
      <rect fill="#FAFFF1" width="540" height="450" />
      <defs>
        <linearGradient
          id="a"
          ...
          y1="0"
          y2="100%"
          gradientTransform="rotate(0,683,324)"
        >
          <stop offset="0" stopColor="#FAFFF1" />
          <stop offset="1" stopColor="#EEFFE9" />
        </linearGradient>
        <pattern
