              ...
              <div className="flex justify-center">
                <div className="w-full px-4 lg:w-9/12">
                  <p className="text-blueGray-700 mb-4 text-base leading-relaxed sm:text-xl">
                    ...
                    Quaerat earum odit officia nulla necessitatibus.
                    Perspiciatis culpa exercitationem obcaecati. Repudiandae
                    illo quasi pariatur nobis sed deleniti fugiat quae iste
                    sapiente possimus voluptatum vitae nemo accusantium omnis
                    aliquid obcaecati necessitatibus, quis ipsa labore error
                    animi sit adipisci. Hic perspiciatis, aperiam ab facere
                    possimus dolorum atque doloribus? Eligendi, reiciendis
                    accusantium nostrum quod adipisci odit, assumenda
                    exercitationem sapiente corrupti explicabo eveniet
                    consequatur, cupiditate libero reprehenderit error sed
                    voluptatum iure nesciunt vero! Explicabo dolorem dolorum
                    magni pariatur alias incidunt, facere officiis quis suscipit
                    placeat odit, accusamus sit, recusandae nesciunt minus
                    dignissimos vero quos tenetur?
                  </p>
                </div>
              </div>
            </div>
